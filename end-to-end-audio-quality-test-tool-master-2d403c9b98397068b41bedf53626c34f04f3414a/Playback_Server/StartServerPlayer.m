...
while 1
    ...
    DoInit = receive_msg(ser); % receiving command for whethet doing the initialization or not
    if DoInit    
        ser.BytesAvailableFcn = '';      
        fprintf('Receiving the reference audio, may take few seconds...\n');		
